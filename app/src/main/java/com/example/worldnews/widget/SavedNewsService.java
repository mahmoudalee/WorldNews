package com.example.worldnews.widget;
...
public class SavedNewsService extends IntentService {
    ...
    public static final String ACTION_GET_NEXT = "com.example.worldnews.widget.action.saved.next";
    public static final String ACTION_GET_PREVIOUS = "com.example.worldnews.widget.action.saved.previous";
    private static final String ACTION_UPDATE_WIDGETS = "com.example.worldnews.widget.action.update_widgets";

    public static final String PARAM_CURRENT = "com.example.worldnews.widget.extra.current_selected";
